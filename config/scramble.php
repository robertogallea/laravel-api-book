...
return [
     ...
     * ],
     */
    // The default patterns (`auth`, `auth:*`) miss `client`, the alias EventHub gives
    // Passport's CheckToken middleware for the partner-facing routes (Chapter 4): without this,
    // Scramble would document `partner/ping` as public, which it is not.
    'security_strategy' => [
